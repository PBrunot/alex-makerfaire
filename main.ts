...
scene.onOverlapTile(SpriteKind.Player, assets.tile`Boss finale blocco`, function (sprite34, location14) {
    ...
    story.spriteSayText(bossFinale, "NON HAI SPERANZE RAGAZZINO", 10, 15, story.TextSpeed.VerySlow)
    story.spriteSayText(bossFinale, "HO MIGLIAIA DI ANNI PIÙ DI TE...", 10, 15, story.TextSpeed.VerySlow)
    story.spriteSayText(bossFinale, "...E SONO MIGLIAIA DI VOLTE PIÙ FORTE DI TE!!!", 10, 15, story.TextSpeed.VerySlow)
